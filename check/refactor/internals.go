...
type ModuleData struct {
	...
	Rodata     uint64    // Added in Go 1.18
	Gofunc     uint64    // Added in Go 1.18
	Covctrs    uint64    // Added in Go 1.20
	Ecovctrs   uint64    // Added in Go 1.20
	InitTasks  GoSlice64 // Added in Go 1.22
}
